...
#include "../R_cut_A_mask_comb_scanline/ras_cut_mask_comb_scanline.h"
...
void VGRasterizer::CreateVertexBuffer()
{
...
float VGRasterizer::RandomPercent()
{
	float ret = static_cast<float>((rand() % 10000) - 5000);
	return ret / 5000.0f;
}

void VGRasterizer::LoadParticles(_Out_writes_(numParticles) Particle* pParticles, const XMFLOAT3& center, const XMFLOAT4& velocity, float spread, UINT numParticles)
{
	srand(0);
...
void VGRasterizer::CreateParticleBuffers()
{
...
void VGRasterizer::WaitForRenderContext()
{
...
void VGRasterizer::MoveToNextFrame()
{
...
DWORD VGRasterizer::AsyncComputeThreadProc(int threadIndex)
{
...
void VGRasterizer::Simulate(UINT threadIndex)
{
	ID3D12GraphicsCommandList* pCommandList = m_computeCommandList[threadIndex].Get();
