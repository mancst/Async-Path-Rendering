...
/** File generated from command line: 4_5_compatibility -spec=gl -version=4.5 -profile=compatibility -style=pointer_c -geninfo -ext=NV_command_list -ext=GL_NV_vertex_buffer_unified_memory -ext=GL_NV_uniform_buffer_unified_memory -ext=NV_parameter_buffer_object -ext=NV_bindless_texture -ext=ARB_bindless_texture -ext=NV_shader_buffer_load -ext=ARB_shading_language_include -ext=NV_path_rendering -ext=EXT_direct_state_access -ext=NV_sample_locations**/

#include <stdlib.h>
#include <string.h>
#include <stddef.h>
#include "gl_4_5_compatibility.h"
...
int ogl_ext_NV_sample_locations = ogl_LOAD_FAILED;
...
GLuint64 (CODEGEN_FUNCPTR *_ptrc_glGetImageHandleNV)(GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum format) = NULL;
GLuint64 (CODEGEN_FUNCPTR *_ptrc_glGetTextureHandleNV)(GLuint texture) = NULL;
GLuint64 (CODEGEN_FUNCPTR *_ptrc_glGetTextureSamplerHandleNV)(GLuint texture, GLuint sampler) = NULL;
GLboolean (CODEGEN_FUNCPTR *_ptrc_glIsImageHandleResidentNV)(GLuint64 handle) = NULL;
GLboolean (CODEGEN_FUNCPTR *_ptrc_glIsTextureHandleResidentNV)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeImageHandleNonResidentNV)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeImageHandleResidentNV)(GLuint64 handle, GLenum access) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeTextureHandleNonResidentNV)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeTextureHandleResidentNV)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glProgramUniformHandleui64NV)(GLuint program, GLint location, GLuint64 value) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glProgramUniformHandleui64vNV)(GLuint program, GLint location, GLsizei count, const GLuint64 * values) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glUniformHandleui64NV)(GLint location, GLuint64 value) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glUniformHandleui64vNV)(GLint location, GLsizei count, const GLuint64 * value) = NULL;
...
GLuint64 (CODEGEN_FUNCPTR *_ptrc_glGetImageHandleARB)(GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum format) = NULL;
GLuint64 (CODEGEN_FUNCPTR *_ptrc_glGetTextureHandleARB)(GLuint texture) = NULL;
GLuint64 (CODEGEN_FUNCPTR *_ptrc_glGetTextureSamplerHandleARB)(GLuint texture, GLuint sampler) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glGetVertexAttribLui64vARB)(GLuint index, GLenum pname, GLuint64EXT * params) = NULL;
GLboolean (CODEGEN_FUNCPTR *_ptrc_glIsImageHandleResidentARB)(GLuint64 handle) = NULL;
GLboolean (CODEGEN_FUNCPTR *_ptrc_glIsTextureHandleResidentARB)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeImageHandleNonResidentARB)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeImageHandleResidentARB)(GLuint64 handle, GLenum access) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeTextureHandleNonResidentARB)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glMakeTextureHandleResidentARB)(GLuint64 handle) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glProgramUniformHandleui64ARB)(GLuint program, GLint location, GLuint64 value) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glProgramUniformHandleui64vARB)(GLuint program, GLint location, GLsizei count, const GLuint64 * values) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glUniformHandleui64ARB)(GLint location, GLuint64 value) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glUniformHandleui64vARB)(GLint location, GLsizei count, const GLuint64 * value) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glVertexAttribL1ui64ARB)(GLuint index, GLuint64EXT x) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glVertexAttribL1ui64vARB)(GLuint index, const GLuint64EXT * v) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glFramebufferSampleLocationsfvNV)(GLenum target, GLuint start, GLsizei count, const GLfloat * v) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glNamedFramebufferSampleLocationsfvNV)(GLuint framebuffer, GLuint start, GLsizei count, const GLfloat * v) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glResolveDepthValuesNV)(void) = NULL;

static int Load_NV_sample_locations(void)
{
	int numFailed = 0;
	_ptrc_glFramebufferSampleLocationsfvNV = (void (CODEGEN_FUNCPTR *)(GLenum, GLuint, GLsizei, const GLfloat *))IntGetProcAddress("glFramebufferSampleLocationsfvNV");
	if(!_ptrc_glFramebufferSampleLocationsfvNV) numFailed++;
	_ptrc_glNamedFramebufferSampleLocationsfvNV = (void (CODEGEN_FUNCPTR *)(GLuint, GLuint, GLsizei, const GLfloat *))IntGetProcAddress("glNamedFramebufferSampleLocationsfvNV");
	if(!_ptrc_glNamedFramebufferSampleLocationsfvNV) numFailed++;
	_ptrc_glResolveDepthValuesNV = (void (CODEGEN_FUNCPTR *)(void))IntGetProcAddress("glResolveDepthValuesNV");
	if(!_ptrc_glResolveDepthValuesNV) numFailed++;
	return numFailed;
}
...
static ogl_StrToExtMap ExtensionMap[11] = {
	...
	{"GL_NV_sample_locations", &ogl_ext_NV_sample_locations, Load_NV_sample_locations},
};
...
static void ClearExtensionVars(void)
{
	...
	ogl_ext_NV_sample_locations = ogl_LOAD_FAILED;
}
