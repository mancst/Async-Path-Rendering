...
public:
	static int Run(DXAsset* pSample, HINSTANCE hInstance, int nCmdShow);
...
class DXAsset : public Object {
public:
	DXAsset(UINT width, UINT height, std::wstring name);
	DXAsset();
	virtual ~DXAsset();
